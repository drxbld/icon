...
def Dialog_Example():
    ...
    main_text = mytext
    my_buttons = ['Leave']
    my_choice = koding.Custom_Dialog(main_content=main_text,pos='center',size='900x750',buttons=my_buttons,transparency=90,highlight_color='yellow',header='MC 1080P')
    if my_choice == 0: 
        return