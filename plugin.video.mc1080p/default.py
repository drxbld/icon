    ...
    try:
        if display_menu == True:
            if enable_newswin == 'true':
                koding.Add_Dir(name='[B]Movie Request Info[COLORyellow] CLICK HERE[/COLOR][/B]', url='{"my_text":"REQUESTS[CR]!!!","my_desc":""}', mode='dialog_example', folder=False, icon=os.path.join(art_path,'icon.png'), fanart=os.path.join(art_path,'fanart.jpg'))
