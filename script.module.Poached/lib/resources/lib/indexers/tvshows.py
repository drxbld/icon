...
class tvshows:
    ...
    def networks(self):
		...
		('Disney Junior', '/networks/1039/disney-junior', 'https://i.imgur.com/XNSuljN.png'),																			   
		...
		('Hulu', '/webchannels/2/hulu', 'https://i.imgur.com/DnEKlfG.png'),															 
		...
		('Sky Go', '/webchannels/117/sky-go', 'https://i.imgur.com/DZrfHZI.png'),																   
