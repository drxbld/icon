    ...
    try:
        if display_menu == True:
            if enable_newswin == 'true':
                koding.Add_Dir(name='[B][COLOR yellow]L[COLOR white]atest [COLOR red]N[COLOR white]ews [COLOR yellow]A[COLOR white]nd [COLOR red]U[COLOR white]pdates[/COLOR][/B]', url='{"my_text":"Latest News[CR]!!!","my_desc":""}', mode='dialog_example', folder=False, icon=os.path.join(art_path,'icon.png'), fanart=os.path.join(art_path,'fanart.jpg'))
