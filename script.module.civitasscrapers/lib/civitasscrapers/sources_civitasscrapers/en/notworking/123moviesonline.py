# -*- coding: UTF-8 -*-
# -Cleaned and Checked on 12-23-2018 by JewBMX in Scrubs.

import re,base64,urllib,urlparse
from resources.lib.modules import client,cleantitle,dom_parser2
...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domains = ['123moviesonline.men']
        self.base_link = 'http://123moviesonline.men'
