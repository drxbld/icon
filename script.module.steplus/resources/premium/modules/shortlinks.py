...
dir= xbmc.translatePath('special://home/addons/plugin.video.Stefano/resources/modules/')
...
def popupd(announce):
	...
	class TextBox():
		...
		def setControls(self):
			self.win.getControl(self.CONTROL_LABEL).setLabel('[COLOR ghostwhite][B]Live[/COLOR][COLOR red] Stefano[/COLOR][/B]') # set heading
