...
default_headers["User-Agent"] = "Mozilla/5.0 (Windows NT 10.0; WOW64; rv:59.0) Gecko/20100101 Firefox/59.0"
...
def downloadpage(url, post=None, headers=None, timeout=60, follow_redirects=True, cookies=True, replace_headers=False,
