    ...
    def tvdb_list(self, tvshowtitle, year, imdb, tvdb, lang, limit=''):
        ...
        for item in episodes:
            try:
                ...
                title = '[COLOR white] %s [/COLOR]' % (title.encode('utf-8'))
                ...
                if label == '': label = '0'
                label = client.replaceHTMLCodes(label)
                label = '[COLOR white] %s [/COLOR]' % (label.encode('utf-8'))
    ...
    def trakt_episodes_list(self, url, user, lang):
        ...
        def items_list(i):
            ...
            try:
                ...
                tvshowtitle = '[COLOR white] %s [/COLOR]' % (i['tvshowtitle'])
                imdb, tvdb = i['imdb'], i['tvdb']
    ...
    def episodeDirectory(self, items):
        ...
        for i in items:
            try:
                ...
                if multi == True:
                    label = '[COLOR white]%s[/COLOR] - %s' % (i['tvshowtitle'], label)
