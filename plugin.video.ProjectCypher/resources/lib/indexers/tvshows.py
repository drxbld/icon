...
import base64,os,sys,re,json,urllib,urlparse,datetime
...
class tvshows:
    def __init__(self):
        ...
        if self.tmdb_key == '' or self.tmdb_key == None: self.tmdb_key = base64.b64decode('OWQxZDY4NDMxZmY0NGM2YmM0MWFmYzk0NjA2ZDk5NTQ=')
