...
class navigator:
    ...
    def movies(self, lite=False):
        self.addDirectoryItem( '[B][COLOR cyan]Change Items Listed (All lists)[/COLOR][/B]','useramount', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem( '[B][COLOR cyan]Current Setting = %s[/COLOR][/B]' % ( ua ),'null', 'tools.png', 'DefaultAddonProgram.png')
        ...
        self.addDirectoryItem( '[B][COLOR cyan]=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=[/COLOR][/B]','null', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem( '[B][COLOR cyan]Change Sort By Setting[/COLOR][/B]','sortby', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem( '[B][COLOR cyan]Current Setting = %s[/COLOR][/B]' % ( uv ),'null', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[B][COLOR yellow]Keywords[/COLOR][/B]', 'Mkeywords', 'genres.png', 'DefaultMovies.png')
    ...
    def tvshows(self, lite=False):
        ...
        self.addDirectoryItem( '[B][COLOR cyan]Change Sort By Setting[/COLOR][/B]','sortby', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem( '[B][COLOR cyan]Current Setting = %s [/COLOR][/B]' % ( uv ),'null', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[B][COLOR yellow]Keywords [/COLOR][/B]', 'TVkeywords', 'genres.png', 'DefaultTVShows.png')
