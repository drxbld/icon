...
addon_id        = 'plugin.video.UniverseHD'
...
baseurl         = 'http://worldkodi.com/UniverseHD/Xml/Base.xml'
adultpass       = selfAddon.getSetting('password')
metaset         = selfAddon.getSetting('enable_meta')
messagetext     = 'http://worldkodi.com/UniverseHD/Xml/Compare.txt'
livematches     = ''
#RUNNER 			= base64.b64decode(b'aHR0cDovL3NpbXRlY2gubmV0MTYubmV0L3lvdXR1YmUucGhwP2lkPQ==')
SEARCH_LIST     = base64.b64decode(b'aHR0cDovL3dvcmxka29kaS5jb20vVW5pdmVyc2VIRC9YbWwvU2VhcmNoLnhtbA==')
...
def GetMenu():
        ...
        for item in match:
            ...
            view(link)
        icon = 'http://worldkodi.com/UniverseHD/Icons/Real-Debrid.png'
...
def SCRAPE_BIGSPORTS(url):
	...
	try:
		...
		dialog.ok("UniverseHD", "Sorry, we could not find any live links at the moment. Please try again later.")
		quit()
...
def SCRAPE_MAMAHD_SPORTS_CHANNELS(url):
    ...
    try:
        ...
        dialog.ok("UniverseHD", "And The Offside Flag Is Up No Link Available")
        quit()
