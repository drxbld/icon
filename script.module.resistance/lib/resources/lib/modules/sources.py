    ...
    def getSources(self, title, year, imdb, tvdb, season, episode, tvshowtitle, premiered, quality='HD', timeout=30):
        ...
        for i in range(0, 4 * timeout):
            ...
            try:
                ...
                if debrid_status:
                    d_4k_label = total_format % ('indigo', d_source_4k) if d_source_4k == 0 else total_format % ('orange', d_source_4k)
                    d_1080_label = total_format % ('indigo', d_source_1080) if d_source_1080 == 0 else total_format % ('orange', d_source_1080)
                    d_720_label = total_format % ('indigo', d_source_720) if d_source_720 == 0 else total_format % ('orange', d_source_720)
                    d_sd_label = total_format % ('indigo', d_source_sd) if d_source_sd == 0 else total_format % ('orange', d_source_sd)
                    d_total_label = total_format % ('indigo', d_total) if d_total == 0 else total_format % ('orange', d_total)

                source_4k_label = total_format % ('indigo', source_4k) if source_4k == 0 else total_format % ('orange', source_4k)
                source_1080_label = total_format % ('indigo', source_1080) if source_1080 == 0 else total_format % ('orange', source_1080)
                source_720_label = total_format % ('indigo', source_720) if source_720 == 0 else total_format % ('orange', source_720)
                source_sd_label = total_format % ('indigo', source_sd) if source_sd == 0 else total_format % ('orange', source_sd)
                source_total_label = total_format % ('indigo', total) if total == 0 else total_format % ('orange', total)
