...
class tvshows:
    def __init__(self):
        ...
        self.popular_link = 'https://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=animation&num_votes=100,&release_date=,date[0]&genres=animation&sort=moviemeter,asc&count=40&start=1'
        ...
        self.views_link = 'https://www.imdb.com/search/title?title_type=tv_series&release_date=2016-01-01,&genres=family'
        ...
        self.animeactive_link = 'https://www.imdb.com/search/keyword?keywords=anime&mode=detail&page=1&title_type=tvSeries&ref_=kw_ref_typ&sort=moviemeter,asc&on_tv=1'
