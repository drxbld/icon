...
class navigator:
    def root(self):
        ...
        self.addDirectoryItem('Kids', 'KidsNavigator', 'bc.png', 'DefaultMovies.png')
        self.addDirectoryItem('Toddler', 'toddlerNavigator', 'bc.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('Teen', 'TeenNavigator', 'bc.png', 'DefaultMovies.png')
        self.addDirectoryItem('Nature', 'NatureNavigator', 'bc.png', 'DefaultMovies.png')
        ...
        #if downloads == True: self.addDirectoryItem(32009, 'downloadNavigator', 'bc.png', 'DefaultFolder.png')

        self.endDirectory()

    def Kids(self, lite=False):
        self.addDirectoryItem('Kids movies', 'movies2&url=tmdbKids', 'bc.png', 'DefaultRecentlyAddedMovies.png')        
        self.addDirectoryItem('Kids T.V Shows', 'tvshows2&url=tmdbKids', 'bc.png', 'DefaultRecentlyAddedMovies.png')
        self.endDirectory()
		
    def Teen(self, lite=False):
        self.addDirectoryItem('Teen Movies', 'movies2&url=tmdbteen', 'bc.png', 'DefaultRecentlyAddedMovies.png')        
        self.addDirectoryItem('Teen T.v Shows', 'tvshows2&url=tmdbteen', 'bc.png', 'DefaultRecentlyAddedMovies.png')		
        self.endDirectory()
		
    def Nature(self, lite=False):
        self.addDirectoryItem('Nature And Learning Movies', 'movies2&url=tmdblearning', 'bc.png', 'DefaultRecentlyAddedMovies.png')       
        self.addDirectoryItem('Nature  And Learning T.V Shows', 'tvshows2&url=tmdblearning', 'bc.png', 'DefaultRecentlyAddedMovies.png')

        self.endDirectory()

    def toddler(self, lite=False):
        self.addDirectoryItem('Toddler tv shows', 'tvshows2&url=tmdbtoddler', 'bc.png', 'decepticons.png')
        self.addDirectoryItem('Toddler movies', 'movies2&url=tmdbtoddler', 'bc.png', 'decepticons.png')
