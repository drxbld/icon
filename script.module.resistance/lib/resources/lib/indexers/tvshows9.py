...
class tvshows:
    ...
    def languagesdrama(self):
        ...
        for i in languages: self.list.append({'name': str(i[0]), 'url': self.languagedrama_link % i[1], 'image': 'languages.jpg', 'action': 'tvshows'})
        self.addDirectory(self.list)
        return self.list
    ...
    def languagesrom(self):
        ...
        for i in languages: self.list.append({'name': str(i[0]), 'url': self.languagerom_link % i[1], 'image': 'languages.jpg', 'action': 'tvshows'})
        self.addDirectory(self.list)
        return self.list
    ...
    def yearsdrama(self):
        ...
        for i in range(int(year)-0, 1970, -1): self.list.append({'name': str(i), 'url': self.yeardrama_link % (str(i), str(i)), 'image': 'years.jpg', 'action': 'tvshows'})
        self.addDirectory(self.list)
        return self.list		
    ...
    def yearsrom(self):
        ...
        for i in range(int(year)-0, 1970, -1): self.list.append({'name': str(i), 'url': self.yearrom_link % (str(i), str(i)), 'image': 'years.jpg', 'action': 'tvshows'})
        self.addDirectory(self.list)
        return self.list
    ...
    def certificationsdrama(self):
        ...
        for i in certificates: self.list.append({'name': str(i), 'url': self.certificationdrama_link % str(i).replace('-', '_').lower(), 'image': 'certificates.jpg', 'action': 'tvshows'})
        self.addDirectory(self.list)
        return self.list
    ...
    def certificationsrom(self):
        ...
        for i in certificates: self.list.append({'name': str(i), 'url': self.certificationrom_link % str(i).replace('-', '_').lower(), 'image': 'certificates.jpg', 'action': 'tvshows'})
        self.addDirectory(self.list)
        return self.list
