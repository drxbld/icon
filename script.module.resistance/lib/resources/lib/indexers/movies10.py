...
class movies:
    def __init__(self):
        ...
        if self.hidecinema == 'true':
            self.popular_link = 'https://www.imdb.com/search/title?title_type=feature&genres=animation,family'
            ...
            self.animepopular_link = 'https://www.imdb.com/search/title?count=100&keywords=anime&num_votes=2000,&explore=title_type&pf_rd_m=A2FGELUUNOQJNL&pf_rd_p=3999419c-1229-4fa7-9240-55e83e21cecb&pf_rd_r=XP4M7Q29XXN28VM9Z00Q&pf_rd_s=right-1&pf_rd_t=15051&pf_rd_i=genre&title_type=movie&ref_=adv_explore_rhs'
            self.animeviews_link = 'https://www.imdb.com/search/title?count=100&keywords=anime&num_votes=2000,&explore=title_type&pf_rd_m=A2FGELUUNOQJNL&pf_rd_p=3999419c-1229-4fa7-9240-55e83e21cecb&pf_rd_r=XP4M7Q29XXN28VM9Z00Q&pf_rd_s=right-1&pf_rd_t=15051&pf_rd_i=genre&title_type=movie&sort=num_votes,desc&ref_=adv_explore_rhs'
            self.animefeatured_link = 'https://www.imdb.com/search/title?count=100&keywords=anime&num_votes=2000,&explore=title_type&pf_rd_m=A2FGELUUNOQJNL&pf_rd_p=3999419c-1229-4fa7-9240-55e83e21cecb&pf_rd_r=6M5CV507ZJQEMFQ8K8Q9&pf_rd_s=right-1&pf_rd_t=15051&pf_rd_i=genre&sort=release_date,desc&title_type=movie&ref_=adv_explore_rhs'
            self.animeyear_link = 'https://www.imdb.com/search/title?count=100&keywords=anime&num_votes=2000,&explore=title_type&pf_rd_m=A2FGELUUNOQJNL&pf_rd_p=3999419c-1229-4fa7-9240-55e83e21cecb&pf_rd_r=4TSXV0JKMKVBW4YXCN93&pf_rd_s=right-1&pf_rd_t=15051&pf_rd_i=genre&sort=year,desc&title_type=movie&ref_=adv_explore_rhs'
            ...
            self.disneypixar_link = 'https://www.imdb.com/list/ls068678217/?sort=alpha,asc&st_dt=&mode=detail&page=1'
            self.disneyliveaction_link = 'https://www.imdb.com/list/ls056913461/?sort=moviemeter,asc&st_dt=&mode=detail&page=1'
            self.disneynature_link = 'https://www.imdb.com/list/ls069033145/?sort=release_date,desc&st_dt=&mode=detail&page=1'
            ...
            self.harry_link = 'https://www.imdb.com/list/ls000630791/?sort=release_date,asc&st_dt=&mode=detail&page=1'
            self.robots_link = 'https://www.imdb.com/search/title?title=transformers&title_type=feature&plot=autobots&sort=release_date,asc'
            ...
            self.halloween_link = 'https://www.imdb.com/list/ls040714321/?sort=moviemeter,asc&st_dt=&mode=detail&page=1'
            self.christmas_link = 'https://www.imdb.com/list/ls040175441/'
