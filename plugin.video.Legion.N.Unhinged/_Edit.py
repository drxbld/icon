...
addon = xbmcaddon.Addon('plugin.video.Legion.N.Unhinged') 
...
MainBase = 'aHR0cDovL215YXRvbS5vbmUvYWRkb24vaG9tZS54bWw='
...
Search_Tv         = False
Search_Content    = True
Search_Content_KeyBoardMsg = 'Search Content'
#####-----TMDB------######
####----TMDB Lists----####
...
ChannelTxtColor1 = 'lime'
ChannelTxtColor2 = 'red'
...
HistoryFanart     = ''
NextPageIcon      = ''
SearchIcon        = 'https://i.imgur.com/X2a0S6w.png'
SearchFanart      = ''
SettingIcon       = ''
SettingFanart     = ''
TmdbIcon          = ''
