<!DOCTYPE HTML>
	<head>
		...
		<script src="/js/pastebin.min.js"></script>
		<link href="/i/pastebin.min.css" rel="stylesheet" type="text/css" />
		<!--[if lt IE 10]>
		...
		<meta property="og:url" content="http://pastebin.com/b9wwkSxe" />
		<meta property="og:image" content="http://pastebin.com/i/facebook.png" />
		<meta property="og:site_name" content="Pastebin" />
		<meta name="google-site-verification" content="jkUAIOE8owUXu8UXIhRLB9oHJsWBfOgJbZzncqHoF4A" />
		<link rel="canonical" href="http://pastebin.com/b9wwkSxe" />
	...
	<div id="main_frame">
		...
		<div id="super_frame">
			<div id="monster_frame">
				<div id="content_frame">
					<div id="content_right">						
									...
									<div id="menu_2">
										<ul class="right_menu"><li><a href="/Qq8vcrqS">Untitled</a><span>2 sec ago</span></li><li><a href="/mB3qfqeP">Untitled</a><span>2 sec ago</span></li><li><a href="/e4HX739P">Untitled</a><span>3 sec ago</span></li><li><a href="/HxgC9D3q">Untitled</a><span>Java | 8 sec ago</span></li><li><a href="/NGKLjw6a">Untitled</a><span>26 sec ago</span></li><li><a href="/ackY2Csk">Untitled</a><span>Lua | 29 sec ago</span></li><li><a href="/Cvnk5Ktg">Untitled</a><span>CSS | 29 sec ago</span></li><li><a href="/ERTJtF0s">Untitled</a><span>Java | 30 sec ago</span></li></ul></div></div>						<div id="abrpm2"></div>
			...
			<script>function iLoveCookies(){days=2;myDate = new Date();myDate.setTime(myDate.getTime()+(days*24*60*60*1000));document.cookie = 'pastebin_note=1; expires=' + myDate.toGMTString();$("#cookie_hide").hide();}</script>
			<div class="content_text no_padding" id="cookie_hide">
				<div id="notice" style="margin: 0 0 10px 0"><span class="noti_exit" onclick="iLoveCookies()" title="Hide this message"></span>
					<b>Pastebin PRO Accounts AUTUMN SPECIAL!</b> For a limited time only get <b>40% discount</b> on a <a href="/pro"><b>LIFETIME PRO</b></a> account! <b><i>Offer Ends Soon</i>!</b>
				</div>
			</div><div id="abrpm"></div>
		...
		<div id="footer">
			...
			<div id="footer_right" class="h_1024">
				...
				<script type="text/javascript"><!--
				  ...
				  e9.snackbar = true;
				//--></script>
				<script type="text/javascript" src="//tags.expo9.exponential.com/tags/Pastebincom/Safe/tags.js"></script><script async type="text/javascript" src="//cdn.fancybar.net/ac/fancybar.js?zoneid=1502&serve=C6ADVKE&placement=pastebin" id="_fancybar_js"></script>
		<script type="text/javascript">
			function abdd() {$("#adb-enabled").show(), $("#adb-not-enabled").hide(), $("#abrpm3").html("<center><iframe src='/_cube_custom.php' id='monkey_3' marginwidth='0' align='center' marginheight='0' hspace='0' vspace='0' frameborder='0' scrolling='no' allowtransparency='true' width='300' height='250' style='width: 300px; height: 250px;'></iframe></center>"), $("#abrpm2").html("<iframe src='/_sky_custom.php' id='monkey' marginwidth='0' align='center' marginheight='0' hspace='0' vspace='0' frameborder='0' scrolling='no' allowtransparency='true' width='160' height='600' style='width: 160px; height: 600px;'></iframe>"), $("#abrpm").html("<iframe src='/_lead_custom.php' id='monkey_2' marginwidth='0' align='center' marginheight='0' hspace='0' vspace='0' frameborder='0' scrolling='no' allowtransparency='true' width='728' height='100' style='width: 728px; height: 100px;'></iframe>")}
