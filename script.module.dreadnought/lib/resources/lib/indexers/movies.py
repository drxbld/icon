...
class movies:
    def __init__(self):
        ...
        self.listexample_link = 'http://www.imdb.com/list/ls002448041/?view=detail&sort=date_added,desc&title_type=movie,short,tvMovie,tvSpecial,video&start=1'
        self.listexample_link = 'http://www.imdb.com/list/ls002557774/?view=detail&sort=date_added,desc&title_type=movie,short,tvMovie,tvSpecial,video&start=1'
        self.listexample_link = 'http://www.imdb.com/list/ls001818278/?view=detail&sort=date_added,desc&title_type=movie,short,tvMovie,tvSpecial,video&start=1'
        self.listexample_link = 'http://www.imdb.com/list/ls020525837/?view=detail&sort=date_added,desc&title_type=movie,short,tvMovie,tvSpecial,video&start=1'
        self.listexample_link = 'http://www.imdb.com/list/ls058155108/?view=detail&sort=date_added,desc&title_type=movie,short,tvMovie,tvSpecial,video&start=1'
