...
class navigator:
    ...
    def movies(self, lite=False):
        ...
        self.addDirectoryItem(32005, 'movieWidget', 'latest-movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('Movies you must see', 'movies&url=listexample', 'latest-movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('Great American Westerns', 'movies&url=listexample', 'latest-movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('Top 100 Gangster Movies', 'movies&url=listexample', 'latest-movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('Marvel Comics', 'movies&url=listexample', 'latest-movies.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('DC Universe', 'movies&url=listexample', 'latest-movies.png', 'DefaultRecentlyAddedMovies.png')
