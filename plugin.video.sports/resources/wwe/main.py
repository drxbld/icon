...
def router(paramstring):
    ...
    if params:
        ...
        list_item = xbmcgui.ListItem(label='Full-Show Replays')
        list_item.setArt({'fanart':fanart,'thumb':icon,'poster':icon})
        list_item.setInfo('video',{'plot':'Full-Show Replays section for all past WWE airings.\n\n[COLOR yellow]Note:[/COLOR] Pin Generation is required to use this section.','title':'Full-Show Replays'})
        url = get_url(sport='wwe', endpoint='replays')
