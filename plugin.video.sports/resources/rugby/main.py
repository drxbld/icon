...
def router(paramstring):
    ...
    if params:
        ...
        list_item.setInfo('video',{'plot':'Full-Game Replays section for all past games from mostly Super League with some Rugby Union & England Premiership games thrown in.\n\n[COLOR yellow]Note:[/COLOR] Pin Generation is required to use this section.','title':'Full-Game Replays'})
