...
MainBase = 'aHR0cDovL3N0ZXB0b2VzcGxhY2UubmV0L05ld1NlcnZlci9ob21lLnhtbA=='
...
Search_Tv         = False
Search_Content    = True
Search_Content_KeyBoardMsg = '[COLOR gold][B]Search[/COLOR] [COLOR green][B]Monster[/COLOR] [COLOR red]Munch[/B][/COLOR]'
#####-----TMDB------######
####----TMDB Lists----####
...
UseTMDB  = True
TMDB_api = 'NWU2YzJlMmIwNWMwOTQzNGFiMzFhNTQzNGM5NTk2YTE='
#####-----Text-----#####
...
HistoryFanart     = ''
NextPageIcon      = ''
SearchIcon        = 'http://steptoesplace.net/lot/SEARCH.png'
SearchFanart      = ''
SettingIcon       = ''
SettingFanart     = ''
TmdbIcon          = ''
