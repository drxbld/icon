...
def iptv4sat():
	...
	dest = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.livehub/downloads/', 'iptv4sat.zip'))
	...
	for a in dir:
		if a.endswith('.m3u'):
			...
			os.remove(xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.livehub/downloads/',a)))
...
logfile    = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.livehub2.Diamondize', 'log.txt'))
