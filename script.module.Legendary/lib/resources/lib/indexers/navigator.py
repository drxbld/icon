...
class navigator:
    def root(self):
        ...
        self.addDirectoryItem(32019, 'movies&url=views', 'channels.png', 'DefaultMovies.png')
    ...
    def movies(self, lite=False):
        ...
        self.addDirectoryItem(32609, 'movies&url=views', 'most-voted.png', 'DefaultMovies.png')
    ...
    def tvshows(self, lite=False):
        ...
        self.addDirectoryItem(32609, 'tvshows&url=views', 'most-voted.png', 'DefaultTVShows.png')
