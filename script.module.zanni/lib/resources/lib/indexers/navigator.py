...
class navigator:
    ...
    NEWSFILE      = 'https://www.13clowns.com/repo/sources/Wizard_files/newsinfo.txt'
    LOCALNEWS     = os.path.join(THISADDONPATH, 'newsinfo.txt')

    def root(self):
        self.addDirectoryItem('Help / Information', 'newsNavigator', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem(32001, 'movieNavigator', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem(32002, 'tvNavigator', 'tvshows.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Movie Collections', 'collectionsNavigator', 'movies.png', 'DefaultMovies.png')
        ...
        self.addDirectoryItem(90000, 'lambdasettings', 'tools.png', 'DefaultAddonProgram.png')
...
###
    ...
    def collections(self, lite=False):
        self.addDirectoryItem('Actor Collections', 'collectionActors', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem('Boxset Collections', 'collectionBoxset', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem('Christmas Collections', 'collections&url=xmasmovies', 'movies.png', 'DefaultMovies.png')
        self.addDirectoryItem('Kids Collections', 'collectionKids', 'movies.png', 'DefaultMovies.png')
    ...
    def tools(self):
        ...
        self.addDirectoryItem(32539, 'smuSettings', 'tools.png', 'DefaultAddonProgram.png')
    ...
    def collectionKids(self):
        ...
        self.addDirectoryItem('Superhero Collection', 'collectionSuperhero', 'collectionsuperhero.png', 'DefaultRecentlyAddedMovies.png')
