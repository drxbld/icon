...
if action == None:
    from resources.lib.indexers import kodighost
    kodighost.indexer().root()

elif action == 'directory':
    from resources.lib.indexers import kodighost
    kodighost.indexer().get(url)

elif action == 'qdirectory':
    from resources.lib.indexers import kodighost
    kodighost.indexer().getq(url)

elif action == 'xdirectory':
    from resources.lib.indexers import kodighost
    kodighost.indexer().getx(url)

elif action == 'developer':
    from resources.lib.indexers import kodighost
    kodighost.indexer().developer()

elif action == 'tvtuner':
    from resources.lib.indexers import kodighost
    kodighost.indexer().tvtuner(url)

elif 'youtube' in str(action):
    from resources.lib.indexers import kodighost
    kodighost.indexer().youtube(url, action)

elif action == 'play':
    from resources.lib.indexers import kodighost
    kodighost.player().play(url, content)

elif action == 'browser':
    from resources.lib.indexers import kodighost
    kodighost.resolver().browser(url)

elif action == 'search':
    from resources.lib.indexers import kodighost
    kodighost.indexer().search(url=None)

elif action == 'addSearch':
    from resources.lib.indexers import kodighost
    kodighost.indexer().addSearch(url)

elif action == 'delSearch':
    from resources.lib.indexers import kodighost
    kodighost.indexer().delSearch()
...
if action == 'boxsetsNavigator':
    ...
    boxsets.navigator().root()
	
elif action == 'actionNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().action()
    
elif action == 'actionliteNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().action(lite=True)

elif action == 'adventureNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().adventure()
    
elif action == 'adventureliteNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().adventure(lite=True)
    
elif action == 'animationNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().animation()
    
elif action == 'animationliteNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().animation(lite=True)
    
elif action == 'comedyNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().comedy()
    
elif action == 'comedyliteNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().comedy(lite=True)
    
elif action == 'crimeNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().crime()
    
elif action == 'crimeliteNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().crime(lite=True)
    
elif action == 'dramaNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().drama()
    
elif action == 'dramaliteNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().drama(lite=True)
    
elif action == 'familyNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().family()
    
elif action == 'familyliteNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().family(lite=True)
    
elif action == 'fantasyNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().fantasy()
    
elif action == 'fantasyliteNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().fantasy(lite=True)

elif action == 'horrorNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().horror()
    
elif action == 'horrorliteNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().horror(lite=True)
    
elif action == 'mysteryNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().mystery()
    
elif action == 'mysteryliteNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().mystery(lite=True)
    
elif action == 'romanceNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().romance()
    
elif action == 'romanceliteNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().romance(lite=True)
    
elif action == 'scifiNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().scifi()
    
elif action == 'scifiliteNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().scifi(lite=True)
    
elif action == 'thrillerNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().thriller()
    
elif action == 'thrillerliteNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().thriller(lite=True)
    
elif action == 'westernNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().western()
    
elif action == 'westernliteNavigator':
    from resources.lib.indexers import boxsets
    boxsets.navigator().western(lite=True)

elif action == 'boxinfo':
    from resources.lib.indexers import boxinfo
    boxinfo.movies().get(url)	
