...
class tvshows:
    ...
    def networks(self):
        ...
        ('DC Universe', '/webchannels/187/dc-universe', 'https://i.imgur.com/tqTM4lz.jpg'),
        ...
        ('Disney+', '/webchannels/287/disney', 'https://icdn2.digitaltrends.com/image/disney-plus-logo.jpg'),		
        ...
        ('Hallmark Everywhere', '/webchannels/98/hallmark-channel-everywhere', 'https://i.imgur.com/zXS64I8.png'),
        ...
        ('YouTube Premium', '/webchannels/43/youtube-premium', 'https://i.imgur.com/7uJBnMr.png')		
        ]
