...
def get_rd_domains():
    ...
    cache_location = os.path.join(
            xbmc.translatePath(xbmcaddon.Addon("script.module.underdogscrapers").getAddonInfo('profile')).decode('utf-8'),
            'url_cache.db')
    try:
